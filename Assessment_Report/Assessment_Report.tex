...
\include{sections/contractinformation}\cleardoublepage
\include{sections/general}\cleardoublepage
\include{sections/introduction}\cleardoublepage
\include{sections/expertassessment}\cleardoublepage{fixme}%cannot be included
\include{sections/answerstoquestions}\cleardoublepage{fixme}%cannot be included
\include{sections/summary}\cleardoublepage{fixme}%cannot be included
\include{sections/recommendationandnotes}\cleardoublepage{fixme}%cannot be included
\include{sections/finalization}\cleardoublepage{fixme}%cannot be included
